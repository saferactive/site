...
date: 'TII Safety Webinar<br/><img class="img-footer" alt="" src="https://www.pct.bike/www/static/01_logos/pct-logo.png"><br/><img class="img-footer" alt="" src="https://www.stephanehess.me.uk/images/picture3.png">'
output:
...
```{r, include=FALSE}
library(RefManageR)
my_bib = RefManageR::ReadBib("~/itsleeds/pct/vignettes/refs.bib")
```

```{r, eval=FALSE, echo=FALSE, engine='bash'}
# publish results online
cp -Rv ~/itsleeds/pct/data-raw/pct-slides-i* ~/saferactive/site/static/slides/
